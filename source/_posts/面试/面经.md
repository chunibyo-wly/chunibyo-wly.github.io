...
6. 网络字节序, 大小端
   ...
   1. 大端: 高位在前, 人类读写数值的方法
   2. 小端: 低位在前
   ![img](https://raw.githubusercontent.com/chunibyo-wly/image-storage/master/bg2016112201.gif)
   3. 除了计算机的内部处理, 其他的场合几乎都是大端字节序, 比如网络传输和文件储存
   4. **"只有读取的时候，才必须区分字节序，其他情况都不用考虑。"**
   5. 历史原因是CPU架构不同, 为了规范所以让网络字节序为大端
   6. ![image-20200323233818841](https://raw.githubusercontent.com/chunibyo-wly/image-storage/master/image-20200323233818841.png)
...
6. 如何创建进程
   ...
   ![img](https://raw.githubusercontent.com/chunibyo-wly/image-storage/master/06.png)
   
7. mysql服务的连接过程
   ![image-20200413074535469](https://raw.githubusercontent.com/chunibyo-wly/image-storage/master/image-20200413074535469.png)
...
1. bash是如何执行命令的
   ...
   2. 执行脚本
      ...
      3. 实例
         ...
         6. ![Shell脚本的执行过程](https://raw.githubusercontent.com/chunibyo-wly/image-storage/master/shellscript.shellexec.png)
...
3. HTTP交互 (1-RTT), 真正传输数据的
   ...
   ![image-20200519165142493](https://raw.githubusercontent.com/chunibyo-wly/image-storage/master/image-20200519165142493.png)
   
   ![image-20200519165246955](https://raw.githubusercontent.com/chunibyo-wly/image-storage/master/image-20200519165246955.png)
...
2. cdn是什么
   **大号的缓存代理**
   ...
   ![img](https://raw.githubusercontent.com/chunibyo-wly/image-storage/master/cdn_1.png)